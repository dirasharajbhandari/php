...
<body>
      ...
      <div class="form">
        <li>
          ...
          <ul class="dropdown">
            ...
            <a href="insert.php"><li>Register</li></a>
          </ul>
        </li>
      </div>
    </div>
  ...
  <div class="main border">
    ...
    <!-- Show status message -->
    <?php if ($status != "") { ?>
      <p style="color: green; font-weight: bold;"><?php echo htmlspecialchars($status); ?></p>
    <?php } ?>
  ...
  <footer class="main-footer">
    <div class="foot">
      ...
      <div class="contact">
        <h2>Contact Us</h2>
        <p>For any query or additional information that you may require from us.</p>
        <br />
